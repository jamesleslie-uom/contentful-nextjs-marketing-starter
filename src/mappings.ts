...
export const componentMap = {
  ComponentCardGrid: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-card-grid/ctf-card-grid').then(
      module => module.CtfCardGrid,
    ),
  ),
...
export const componentGqlMap = {
  ...pageTopicMap,
  ComponentCardGrid: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-card-grid/ctf-card-grid-gql').then(
      module => module.CtfCardGridGql,
    ),
  ),
  ComponentCta: dynamic(() =>
